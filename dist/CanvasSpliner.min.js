...
b,this._height=c,p.appendChild(this._canvas),this._ctx=this._canvas.getContext("2d"),this._ctx.scale(this._screenRatio,this._screenRatio),this._canvas.addEventListener("mousemove",this._onCanvasMouseMove.bind(this),!1),this._canvas.addEventListener("mousedown",this._onCanvasMouseDown.bind(this),!1),this._canvas.addEventListener("mouseup",this._onCanvasMouseUp.bind(this),!1),this._canvas.addEventListener("dblclick",this._onCanvasMouseDbclick.bind(this),!1),this._canvas.addEventListener("mouseleave",
this._onCanvasMouseLeave.bind(this),!1),this._canvas.addEventListener("mouseenter",this._onCanvasMouseEnter.bind(this),!1),this._canvas.addEventListener("keyup",this._onKeyUp.bind(this),!1),this._splineConstructor=g,"monotonic"===h&&(this._splineConstructor=q),this._pointCollection=new e,this._pointCollection.setBoundary("max","x",b),this._pointCollection.setBoundary("max","y",c),this._xSeriesInterpolated=(new Float32Array(this._width)).fill(0),this._ySeriesInterpolated=(new Float32Array(this._width)).fill(0),
this._gridStep=1/3,this._onEvents={movePoint:null,releasePoint:null,pointAdded:null},this.draw()};c.prototype.getXSeriesInterpolated=function(){return this._xSeriesInterpolated};c.prototype.getYSeriesInterpolated=function(){return this._ySeriesInterpolated};c.prototype.setControlPointRadius=function(a){this._controlPointRadius=a};c.prototype.setControlPointColor=function(a,b){this._controlPointColor[a]=b};c.prototype.setCurveColor=function(a,b){this._curveColor[a]=b};c.prototype.setGridColor=function(a){this._gridColor=
a};c.prototype.setGridStep=function(a){this._gridStep=0>=a||1<=a?0:a;this.draw()};c.prototype.setTextColor=function(a){this._textColor=a};c.prototype.setCurveThickness=function(a){this._curveThickness=a};c.prototype.setBackgroundColor=function(a){this._backgroundColor=a};c.prototype.setSplineType=function(a){this._splineConstructor="monotonic"===a?q:g};c.prototype._updateMousePosition=function(a){var b=this._canvas.getBoundingClientRect();this._mouse={x:a.clientX-b.left,y:this._height-(a.clientY-
b.top)}};c.prototype._onCanvasMouseMove=function(a){this._updateMousePosition(a);if(a=this._pointCollection.getClosestFrom(this._mouse))-1==this._pointGrabbedIndex?a.distance<=this._controlPointRadius?this._pointHoveredIndex=a.index:(a=!1,-1!=this._pointHoveredIndex&&(a=!0),this._pointHoveredIndex=-1,a&&this.draw()):this._pointHoveredIndex=this._pointGrabbedIndex=this._pointCollection.updatePoint(this._pointGrabbedIndex,this._mouse),-1==this._pointHoveredIndex&&-1==this._pointGrabbedIndex||this.draw(),
-1!=this._pointGrabbedIndex&&(a=this._pointCollection.getPoint(this._pointGrabbedIndex),this._drawCoordinates(Math.round(a.x/this._width*1E3)/1E3,Math.round(a.y/this._height*1E3)/1E3),this._onEvents.movePoint&&this._onEvents.movePoint(this))};c.prototype._onCanvasMouseDown=function(a){this._mouseDown=!0;-1!=this._pointHoveredIndex&&(this._pointGrabbedIndex=this._pointHoveredIndex)};c.prototype._onCanvasMouseUp=function(a){a=-1!=this._pointGrabbedIndex;this._mouseDown=!1;this._pointGrabbedIndex=-1;
this.draw();this._onEvents.releasePoint&&a&&this._onEvents.releasePoint(this)};c.prototype._onCanvasMouseDbclick=function(a){this._canvas.focus();-1==this._pointHoveredIndex?this._pointHoveredIndex=this.add({x:this._mouse.x/this._width,y:this._mouse.y/this._height}):(this.remove(this._pointHoveredIndex),this._pointGrabbedIndex=this._pointHoveredIndex=-1)};c.prototype._onCanvasMouseLeave=function(a){this._mouse=null;this._canvas.blur();this._canvas.style.border=this._borderStyle.out;this._mouseDown=
!1;this._pointHoveredIndex=this._pointGrabbedIndex=-1;this.draw()};c.prototype._onCanvasMouseEnter=function(a){this._canvas.focus();this._canvas.style.border=this._borderStyle.in};c.prototype._onKeyUp=function(a){if(this._mouse)switch(a.key){case "d":this.remove(this._pointHoveredIndex)}};c.prototype.add=function(a,b){b=void 0===b?!0:b;var c=null;"x"in a&&"y"in a&&(a.x*=this._width,a.y*=this._height,c=this._pointCollection.add(a));b&&this.draw();this._onEvents.pointAdded&&this._onEvents.pointAdded(this);
return c};c.prototype.remove=function(a){this._pointCollection.remove(a);this.draw();this._onEvents.pointRemoved&&this._onEvents.pointRemoved(this)};c.prototype.draw=function(){this._ctx.clearRect(0,0,this._width,this._height);this._fillBackground();this._drawGrid();this._drawData()};c.prototype._fillBackground=function(){this._backgroundColor&&(this._ctx.beginPath(),this._ctx.rect(0,0,this._width,this._height),this._ctx.fillStyle=this._backgroundColor,this._ctx.fill())};c.prototype._drawCoordinates=
function(a,b){var c=14/this._screenRatio;this._ctx.fillStyle=this._textColor;this._ctx.font=c+"px courier";this._ctx.fillText("x: "+a,10/this._screenRatio,20/this._screenRatio);this._ctx.fillText("y: "+b,10/this._screenRatio,35/this._screenRatio)};c.prototype._drawGrid=function(){var a=this._gridStep;if(0!=a){this._ctx.beginPath();this._ctx.moveTo(0,0);for(var b=a*this._height/this._screenRatio;b<this._height/this._screenRatio;b+=a*this._height/this._screenRatio)this._ctx.moveTo(0,Math.round(b)+.5/
this._screenRatio),this._ctx.lineTo(this._width,Math.round(b)+.5/this._screenRatio);this._ctx.moveTo(0,0);for(b=a*this._width/this._screenRatio;b<this._width/this._screenRatio;b+=a*this._width/this._screenRatio)this._ctx.moveTo(Math.round(b)+.5/this._screenRatio,0),this._ctx.lineTo(Math.round(b)+.5/this._screenRatio,this._height);this._ctx.strokeStyle=this._gridColor;this._ctx.lineWidth=.5;this._ctx.stroke();this._ctx.closePath()}};c.prototype._drawData=function(a,b){a=void 0===a?!0:a;b=void 0===
b?!0:b;var c=this._pointCollection.getXseries(),e=this._pointCollection.getYseries(),h=this._width,g=this._height;if(c.length){if(a){this._ctx.beginPath();this._ctx.moveTo(c[0]/this._screenRatio,(g-e[0])/this._screenRatio);a=new this._splineConstructor(c,e);this._xSeriesInterpolated.fill(0);this._ySeriesInterpolated.fill(0);for(var m=0;m<Math.ceil(c[0]);m++){var d=e[0];this._xSeriesInterpolated[m]=m/h;this._ySeriesInterpolated[m]=d/g;d=0>d?.5:d>g?g-.5:d;this._ctx.lineTo(m/this._screenRatio,(g-d)/
this._screenRatio)}for(m=Math.ceil(c[0]);m<Math.ceil(c[c.length-1]);m++)d=a.interpolate(m),this._xSeriesInterpolated[m]=m/h,this._ySeriesInterpolated[m]=d/g,d=0>d?.5:d>g?g-.5:d,this._ctx.lineTo(m/this._screenRatio,(g-d)/this._screenRatio);for(m=Math.ceil(c[c.length-1]);m<h;m++)d=e[e.length-1],this._xSeriesInterpolated[m]=m/h,this._ySeriesInterpolated[m]=d/g,d=0>d?.5:d>g?g-.5:d,this._ctx.lineTo(m/this._screenRatio,(g-d)/this._screenRatio);this._ctx.strokeStyle=-1==this._pointGrabbedIndex?this._curveColor.idle:
this._curveColor.moving;this._ctx.lineWidth=this._curveThickness/this._screenRatio;this._ctx.stroke();this._ctx.closePath()}if(b)for(b=0;b<c.length;b++)this._ctx.beginPath(),this._ctx.arc(c[b]/this._screenRatio,(g-e[b])/this._screenRatio,this._controlPointRadius/this._screenRatio,0,2*Math.PI),this._ctx.fillStyle=-1==this._pointHoveredIndex?this._controlPointColor.idle:b==this._pointHoveredIndex?this._mouseDown?this._controlPointColor.grabbed:this._controlPointColor.hovered:this._controlPointColor.idle,
this._ctx.fill(),this._ctx.closePath()}};c.prototype.getValue=function(a){var b=this._pointCollection.getXseries(),c=this._pointCollection.getYseries();return a<=b[0]/this._width?c[0]/this._height:a>=b[b.length-1]/this._width?c[c.length-1]/this._height:(new this._splineConstructor(b,c)).interpolate(a*this._width)/this._height};c.prototype.on=function(a,b){this._onEvents[a]=b};h.CanvasSpliner=c;Object.defineProperty(h,"__esModule",{value:!0})});
